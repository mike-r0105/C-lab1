...
Console.WriteLine("Hello, Michael Ramos");
...
string[] names2 = new[] { "Kantrell", "James", "Recca", "Tony" };
...
string[,] grid1 = new[,] // two dimensions
{
  ...
  { "Orange", "Raspberry", "Honeydew", "Watermelon" },
  { "Pear", "Starfruit", "Pineapple", "Mango" }
};
...
/* Task 3 completed by Michael Ramos */
